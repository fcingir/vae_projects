...
Example Usage: 
	python draw_fashion.py --data_dir=/tmp/draw --read_attn=True --write_attn=True
	python draw_fashion.py --data_dir=/tmp/draw --read_attn=False --write_attn=False
...
directory = 'C:\\Users\\31687\\Desktop\\draw_tensorflow\\draw\\fashionmnist'
file = directory + '/train-labels-idx1-ubyte'
y_train = np.fromfile(file, '>u1', 60000)
