...
Example Usage: 
	python draw_mnist_validation_svhn.py --data_dir=/tmp/draw --read_attn=True --write_attn=True
...
#file = directory + '/train_32x32.mat'
#image_ind = 10
#train_data = sio.loadmat(file)

directory = 'C:\\Users\\31687\\Desktop\\draw_tensorflow\\draw\\svhn'
file = directory + '/test_32x32.mat'
test_data = sio.loadmat(file)

# access to the dict
test_data = test_data['X']/255.0
...
out_file=os.path.join(FLAGS.data_dir,"drawmodel_mnist_ndim10_256_SVHN_validation.npy")
