...
Example Usage: 
	...
	python draw.py --data_dir=/tmp/draw --read_attn=False --write_attn=False
...
#train_data = input_data.read_data_sets(data_directory, one_hot=True).train # binarized (0-1) mnist data

#import sklearn.datasets
#train_data = sklearn.datasets.load_files(data_directory, shuffle='False') #Fatty experiment
import gzip
import numpy as np
...
for e in range(epochs):
        ...
        for i in range(period):
                ...
                if len(batch_xtrain) < batch_size:
                    print(i)
                    #break
