...
Example Usage: 
	python draw_mnist_halfmissing.py --data_dir=/tmp/draw --read_attn=True --write_attn=True
	python draw_mnist_halfmissing.py --data_dir=/tmp/draw --read_attn=False --write_attn=False
# NOTE THIS SAVES TO //:C/tmp/draw
...
undesired_labels2 = [0,1,2,3,4]
train_data = label_remove(train_data, y_train, undesired_labels2)
...
out_file=os.path.join(FLAGS.data_dir,"draw_data_mnist_ndim10_firstlabelhalfmissing.npy")
np.save(out_file,[canvases,Lxs,Lzs])
print("Outputs saved in file: %s" % out_file)

ckpt_file=os.path.join(FLAGS.data_dir,"drawmodel_mnist_ndim10_firstlabelhalfmissing.ckpt")
