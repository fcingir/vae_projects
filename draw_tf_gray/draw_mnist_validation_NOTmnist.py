...
Example Usage: 
	python draw_mnist_validation_NOTmnist.py --data_dir=/tmp/draw --read_attn=True --write_attn=True
...
_, test_data, _, _ = prepare_dataset_notMNIST()

# arr is now a np.ndarray type of object of shape 10000, 28, 28
#test_data = np.array([a.flatten() for a in input_data])/255.0
...
out_file=os.path.join(FLAGS.data_dir,"TESTYTESTY_notMNIST.npy")
