...
Example Usage: 
	python draw_mnist.py --data_dir=/tmp/mnist --read_attn=True --write_attn=True
	python draw_mnist.py --data_dir=/tmp/mnist --read_attn=False --write_attn=False
...
dec_size = 256
read_n = 4 # read glimpse grid width/height
write_n = 4 # write glimpse grid width/height
...
#
#input_data, _, _, _ = prepare_dataset_mnist()
#
...
#out_file=os.path.join(FLAGS.data_dir,"draw_data_mnist_ndim200.npy")
#np.save(out_file,[canvases,Lxs,Lzs])
#print("Outputs saved in file: %s" % out_file)

ckpt_file=os.path.join(FLAGS.data_dir,"drawmodel_mnist_ndim128.ckpt")
