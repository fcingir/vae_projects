...
Example Usage: 
	python draw_fashion_mnist_halfmissing.py --data_dir=/tmp/draw --read_attn=True --write_attn=True
	python draw_fashion_mnist_halfmissing.py --data_dir=/tmp/draw --read_attn=False --write_attn=False
...
undesired_labels1 = [0,1,2,3,4]
undesired_labels2 = [5,6,7,8,9]
...
ckpt_file=os.path.join(FLAGS.data_dir,"drawmodel_fashion_mnist_ndim10_secondlabelhalfmissing.ckpt")
