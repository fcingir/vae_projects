...
class Draw():
    ...
    def train(self):
        data = glob(os.path.join("C:\\Users\\31687\\Desktop\\draw_tensorflow\\draw\\svhn_images_validation", "*.jpg"))
        ...
        data_dir = 'C:\\tmp\\draw'
        out_file=os.path.join(data_dir,"draw_data_SVHN_ndim10_256_validation.npy")
        np.save(out_file,[cses,gen_losses,lat_losses,reconstruct_errors])
...
data1 = glob(os.path.join("C:\\Users\\31687\\Desktop\\draw_tensorflow\\draw\\svhn_images_validation", "*.jpg"))
